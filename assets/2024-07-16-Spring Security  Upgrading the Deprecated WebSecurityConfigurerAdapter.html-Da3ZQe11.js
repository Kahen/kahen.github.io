import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as i,o as n,a as t}from"./app-D4B8YWfq.js";const r={},s=t(`<hr><h1 id="spring-security-升级已弃用的-websecurityconfigureradapter" tabindex="-1"><a class="header-anchor" href="#spring-security-升级已弃用的-websecurityconfigureradapter"><span>Spring Security：升级已弃用的 WebSecurityConfigurerAdapter</span></a></h1><figure><img src="https://www.baeldung.com/wp-content/uploads/2022/04/announcement-icon.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>如果你正在处理 Spring Security（特别是 OAuth）实现，一定要看看《Learn Spring Security》课程：</p><p><strong>&gt;</strong> <strong>学习 Spring</strong> <strong>安全</strong></p><h2 id="_1-概述" tabindex="-1"><a class="header-anchor" href="#_1-概述"><span>1. 概述</span></a></h2><p>Spring Security 允许通过扩展 <em>WebSecurityConfigurerAdapter</em> 类来自定义 HTTP 安全，例如端点授权或认证管理器配置。然而，在最近的版本中，Spring 弃用了这种方法，并鼓励使用基于组件的安全配置。</p><p>在本教程中，我们将学习如何在 Spring Boot 应用程序中替换这种弃用，并运行一些 MVC 测试。</p><p><strong>我们通常看到 Spring HTTP 安全配置类扩展了 <em>WebSecurityConfigureAdapter</em> 类。</strong></p><p>然而，从版本 5.7.0-M2 开始，Spring 弃用了 <em>WebSecurityConfigureAdapter</em> 的使用，并建议创建不包含它的配置。</p><p>让我们创建一个使用内存认证的示例 Spring Boot 应用程序来展示这种新类型的配置。</p><p>首先，我们将定义我们的配置类：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>@Configuration
@EnableWebSecurity
