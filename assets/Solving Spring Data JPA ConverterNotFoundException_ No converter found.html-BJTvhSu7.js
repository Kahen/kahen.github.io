...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>正如预期的那样，基于接口的解决方案奏效。</p><h2 id="_4-结论" tabindex="-1"><a class="header-anchor" href="#_4-结论"><span>4. 结论</span></a></h2><p>在本文中，我们学习了什么导致Spring Data JPA出现_ConverterNotFoundException_。在此过程中，我们看到了如何在实践中重现和修复异常。</p><p>如常，示例的完整源代码可在GitHub上找到。</p>`,46),s=[l];function d(r,o){return i(),n("div",null,s)}const v=e(a,[["render",d],["__file","Solving Spring Data JPA ConverterNotFoundException_ No converter found.html.vue"]]),c=JSON.parse('{"path":"/posts/baeldung/Solving%20Spring%20Data%20JPA%20ConverterNotFoundException_%20No%20converter%20found.html","title":"解决Spring Data JPA转换器未找到异常：没有找到转换器 | Baeldung","lang":"zh-CN","frontmatter":{"date":"2024-06-14T00:00:00.000Z","category":["Spring Data JPA","ConverterNotFoundException"],"tag":["Spring Data JPA","JPA","DTO","Converter"],"description":"解决Spring Data JPA转换器未找到异常：没有找到转换器 | Baeldung 1. 概述 在使用Spring Data JPA时，我们经常利用派生和自定义查询以我们偏好的格式返回结果。一个典型的例子是DTO投影，它提供了一种很好的方式仅选择某些特定列，减少选择不必要数据的开销。 然而，DTO投影并不总是容易实现，如果实现不当可能会导致_Co...","head":[["meta",{"property":"og:url","content":"https://www.kahen.xyz/posts/baeldung/Solving%20Spring%20Data%20JPA%20ConverterNotFoundException_%20No%20converter%20found.html"}],["meta",{"property":"og:site_name","content":"Baeldung 中文网 | Java 教程 | Spring 教程 | REST 教程"}],["meta",{"property":"og:title","content":"解决Spring Data JPA转换器未找到异常：没有找到转换器 | Baeldung"}],["meta",{"property":"og:description","content":"解决Spring Data JPA转换器未找到异常：没有找到转换器 | Baeldung 1. 概述 在使用Spring Data JPA时，我们经常利用派生和自定义查询以我们偏好的格式返回结果。一个典型的例子是DTO投影，它提供了一种很好的方式仅选择某些特定列，减少选择不必要数据的开销。 然而，DTO投影并不总是容易实现，如果实现不当可能会导致_Co..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-06-14T03:42:46.000Z"}],["meta",{"property":"article:author","content":"Kahen"}],["meta",{"property":"article:tag","content":"Spring Data JPA"}],["meta",{"property":"article:tag","content":"JPA"}],["meta",{"property":"article:tag","content":"DTO"}],["meta",{"property":"article:tag","content":"Converter"}],["meta",{"property":"article:published_time","content":"2024-06-14T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-06-14T03:42:46.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"解决Spring Data JPA转换器未找到异常：没有找到转换器 | Baeldung\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2024-06-14T00:00:00.000Z\\",\\"dateModified\\":\\"2024-06-14T03:42:46.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Kahen\\",\\"url\\":\\"https://www.kahen.xyz\\"}]}"]]},"headers":[{"level":2,"title":"1. 概述","slug":"_1-概述","link":"#_1-概述","children":[]},{"level":2,"title":"2. 实践中的异常理解","slug":"_2-实践中的异常理解","link":"#_2-实践中的异常理解","children":[{"level":3,"title":"2.1. H2配置","slug":"_2-1-h2配置","link":"#_2-1-h2配置","children":[]},{"level":3,"title":"2.2. 实体类","slug":"_2-2-实体类","link":"#_2-2-实体类","children":[]},{"level":3,"title":"2.3. JPA存储库","slug":"_2-3-jpa存储库","link":"#_2-3-jpa存储库","children":[]}]},{"level":2,"title":"3. 解决方案","slug":"_3-解决方案","link":"#_3-解决方案","children":[]},{"level":2,"title":"4. 结论","slug":"_4-结论","link":"#_4-结论","children":[]}],"git":{"createdTime":1718296817000,"updatedTime":1718336566000,"contributors":[{"name":"Kahen","email":"Kahen@users.noreply.github.com","commits":1},{"name":"Lance Li","email":"lance.jx.li@gtomato.com","commits":1}]},"readingTime":{"minutes":3.95,"words":1186},"filePathRelative":"posts/baeldung/Solving Spring Data JPA ConverterNotFoundException: No converter found.md","localizedDate":"2024年6月14日","excerpt":"\\n<h2>1. 概述</h2>\\n<p>在使用Spring Data JPA时，我们经常利用派生和自定义查询以我们偏好的格式返回结果。一个典型的例子是DTO投影，它提供了一种很好的方式仅选择某些特定列，减少选择不必要数据的开销。</p>\\n<p>然而，DTO投影并不总是容易实现，如果实现不当可能会导致_ConverterNotFoundException_。因此，在本简短教程中，我们将阐明如何在使用Spring Data JPA时避免_ConverterNotFoundException_异常。</p>\\n<h2>2. 实践中的异常理解</h2>\\n<p>在跳转到解决方案之前，让我们通过一个实际例子来理解异常及其堆栈跟踪的含义。</p>","autoDesc":true}');export{v as comp,c as data};
