import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as t,o as n,a as i}from"./app-DFJO5AEy.js";const a={},s=i(`<h1 id="在jsonobject中获取值" tabindex="-1"><a class="header-anchor" href="#在jsonobject中获取值"><span>在JSONObject中获取值</span></a></h1><p>在本教程中，我们将深入探讨在_JSONObject_实例中获取值的具体细节。</p><p>对于Java中JSON支持的一般介绍，请查看JSON-Java的介绍。</p><h2 id="jsonobject结构" tabindex="-1"><a class="header-anchor" href="#jsonobject结构"><span>JSONObject结构</span></a></h2><p><strong>_JSONObject_是一种类似映射的结构</strong>。它将数据保存为一组键值对。<strong>键是_String_类型，而值可以是几种类型</strong>。<strong>此外，值类型可以是原始的或复合的</strong>。原始类型是_String_、_Number_和_Boolean_类型，或_JSONObject.NULL_对象。复合类型是_JSONObject_和_JSONArray_类型。因此，JSON数据可以具有任意的复杂性和嵌套。</p><p>因此，获取嵌套结构中的值需要更多的努力。从这一点开始，让我们参考以下虚构员工的JSON数据：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>{
  &quot;name&quot; : &quot;Bob&quot;,
