import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as t,o as n,a as i}from"./app-CiQyLZlG.js";const a={},r=i(`<h1 id="如何在spring-data中访问entitymanager-baeldung" tabindex="-1"><a class="header-anchor" href="#如何在spring-data中访问entitymanager-baeldung"><span>如何在Spring Data中访问EntityManager | Baeldung</span></a></h1><h2 id="_1-概览" tabindex="-1"><a class="header-anchor" href="#_1-概览"><span>1. 概览</span></a></h2><p>在开发Spring Data应用程序时，我们通常不需要直接访问_EntityManager_。然而，在某些情况下，我们可能想要访问它，比如创建自定义查询或分离实体。</p><p>在这个快速教程中，我们将学习如何通过扩展Spring Data Repository来访问_EntityManager_。</p><h2 id="_2-访问entitymanager" tabindex="-1"><a class="header-anchor" href="#_2-访问entitymanager"><span>2. 访问EntityManager</span></a></h2><p>我们可以通过创建一个自定义仓库来获取_EntityManager_，例如扩展内置的_JpaRepository_。</p><p>首先，我们将定义一个示例_实体_，用于存储我们想要在数据库中存储的用户：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>@Entity
public class User {
    @Id
    @GeneratedValue
    private Long id;
