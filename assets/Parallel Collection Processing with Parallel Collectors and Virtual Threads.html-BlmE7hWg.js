...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-结论" tabindex="-1"><a class="header-anchor" href="#_5-结论"><span>5. 结论</span></a></h2><p>在这篇文章中，我们有机会看到如何轻松地利用虚拟线程与并行收集器库，事实证明，它比传统的基于操作系统线程的解决方案更好地扩展。我们的测试机器在大约~16000个线程时达到了资源限制，而扩展到数百万虚拟线程却很容易。</p><p>如常，代码示例可以在GitHub上找到。</p><p>文章发布后30天内开放评论。对于超过此日期的任何问题，请使用网站上的联系表单。</p><p>OK</p>`,55),s=[n];function r(d,c){return a(),t("div",null,s)}const v=e(i,[["render",r],["__file","Parallel Collection Processing with Parallel Collectors and Virtual Threads.html.vue"]]),p=JSON.parse('{"path":"/posts/baeldung/Parallel%20Collection%20Processing%20with%20Parallel%20Collectors%20and%20Virtual%20Threads.html","title":"Java虚拟线程和并行收集器的并行集合处理","lang":"zh-CN","frontmatter":{"date":"2024-06-19T00:00:00.000Z","category":["Java","Concurrency"],"tag":["Virtual Threads","Parallel Collectors"],"head":[["meta",{"name":"keywords","content":"Java, Virtual Threads, Parallel Collectors, Project Loom, JDK21, Stream API, concurrency, performance"}],["meta",{"property":"og:url","content":"https://www.kahen.xyz/posts/baeldung/Parallel%20Collection%20Processing%20with%20Parallel%20Collectors%20and%20Virtual%20Threads.html"}],["meta",{"property":"og:site_name","content":"Baeldung 中文网 | Java 教程 | Spring 教程 | REST 教程"}],["meta",{"property":"og:title","content":"Java虚拟线程和并行收集器的并行集合处理"}],["meta",{"property":"og:description","content":"Java虚拟线程和并行收集器的并行集合处理 1. 引言 在之前的文章中，我们介绍了并行收集器，这是一个小型的零依赖库，它使得自定义线程池中的Stream API能够进行并行处理。 Project Loom是引入轻量级虚拟线程（之前称为Fibers）到JVM的有组织努力的代号，最终在JDK21中完成。 让我们看看如何利用这个技术在并行收集器中。 2. M..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-06-20T04:05:49.000Z"}],["meta",{"property":"article:author","content":"Kahen"}],["meta",{"property":"article:tag","content":"Virtual Threads"}],["meta",{"property":"article:tag","content":"Parallel Collectors"}],["meta",{"property":"article:published_time","content":"2024-06-19T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-06-20T04:05:49.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Java虚拟线程和并行收集器的并行集合处理\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2024-06-19T00:00:00.000Z\\",\\"dateModified\\":\\"2024-06-20T04:05:49.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Kahen\\",\\"url\\":\\"https://www.kahen.xyz\\"}]}"]],"description":"Java虚拟线程和并行收集器的并行集合处理 1. 引言 在之前的文章中，我们介绍了并行收集器，这是一个小型的零依赖库，它使得自定义线程池中的Stream API能够进行并行处理。 Project Loom是引入轻量级虚拟线程（之前称为Fibers）到JVM的有组织努力的代号，最终在JDK21中完成。 让我们看看如何利用这个技术在并行收集器中。 2. M..."},"headers":[{"level":2,"title":"1. 引言","slug":"_1-引言","link":"#_1-引言","children":[]},{"level":2,"title":"2. Maven依赖","slug":"_2-maven依赖","link":"#_2-maven依赖","children":[{"level":3,"title":"3.1. 操作系统线程并行性","slug":"_3-1-操作系统线程并行性","link":"#_3-1-操作系统线程并行性","children":[]},{"level":3,"title":"3.2. 虚拟线程并行性","slug":"_3-2-虚拟线程并行性","link":"#_3-2-虚拟线程并行性","children":[]},{"level":3,"title":"3.3. 虚拟线程和旧版本的并行收集器","slug":"_3-3-虚拟线程和旧版本的并行收集器","link":"#_3-3-虚拟线程和旧版本的并行收集器","children":[]}]},{"level":2,"title":"5. 结论","slug":"_5-结论","link":"#_5-结论","children":[]}],"git":{"createdTime":1718748664000,"updatedTime":1718856349000,"contributors":[{"name":"Kahen","email":"Kahen@users.noreply.github.com","commits":1},{"name":"Lance Li","email":"lance.jx.li@gtomato.com","commits":1}]},"readingTime":{"minutes":4.6,"words":1380},"filePathRelative":"posts/baeldung/Parallel Collection Processing with Parallel Collectors and Virtual Threads.md","localizedDate":"2024年6月19日","excerpt":"\\n<h2>1. 引言</h2>\\n<p>在之前的文章中，我们介绍了并行收集器，这是一个小型的零依赖库，它使得自定义线程池中的Stream API能够进行并行处理。</p>\\n<p>Project Loom是引入轻量级虚拟线程（之前称为Fibers）到JVM的有组织努力的代号，最终在JDK21中完成。</p>\\n<p>让我们看看如何利用这个技术在并行收集器中。</p>\\n<h2>2. Maven依赖</h2>\\n<p>如果我们想开始使用这个库，我们需要在Maven的_pom.xml_文件中添加一个单一条目：</p>\\n<div class=\\"language-text\\" data-ext=\\"text\\" data-title=\\"text\\"><pre class=\\"language-text\\"><code>`&lt;dependency&gt;`\\n    `&lt;groupId&gt;`com.pivovarit`&lt;/groupId&gt;`\\n    `&lt;artifactId&gt;`parallel-collectors`&lt;/artifactId&gt;`\\n    `&lt;version&gt;`3.0.0`&lt;/version&gt;`\\n`&lt;/dependency&gt;`\\n</code></pre></div>","autoDesc":true}');export{v as comp,p as data};
