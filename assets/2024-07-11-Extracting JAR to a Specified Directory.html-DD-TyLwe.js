import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,o as s,a as e}from"./app-BCpzTr_e.js";const i={},t=e(`<h1 id="提取jar文件到指定目录" tabindex="-1"><a class="header-anchor" href="#提取jar文件到指定目录"><span>提取JAR文件到指定目录</span></a></h1><p>通常，当我们在Java项目中需要JAR文件时，我们会将它们作为外部库放在类路径中而不解压缩。然而，有时我们可能需要将它们解压到文件系统中。</p><p>在本教程中，我们将探讨如何在命令行中将JAR文件解压到指定目录。<strong>我们将以Linux和Bash为例来介绍每种方法</strong>。</p><h3 id="_2-问题介绍" tabindex="-1"><a class="header-anchor" href="#_2-问题介绍"><span>2. 问题介绍</span></a></h3><p>我们将以Guava的JAR文件为例，在本教程中。在编写本文时，最新版本是guava-31.1-jre.jar。</p><p>Java提供了_jar_命令来创建、更新、查看和解压JAR文件。接下来，让我们使用_jar_命令解压Guava的JAR文件：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ tree /tmp/test/jarTest
/tmp/test/jarTest
└── guava-31.1-jre.jar
