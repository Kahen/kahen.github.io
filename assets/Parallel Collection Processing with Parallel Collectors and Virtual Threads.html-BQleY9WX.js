import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,o as l,a as t}from"./app-C7KViUAf.js";const i={},n=t(`<p>很抱歉，由于网络问题，我无法访问并解析您提供的链接。请您检查链接是否有效，并确保网页可以正常访问。如果链接有效且可访问，您可以重新发送链接，我将尽力为您提供所需的翻译服务。--- date: 2024-06-19 category:</p><ul><li>Java</li><li>Concurrency tag:</li><li>Virtual Threads</li><li>Parallel Collectors head:</li><li><ul><li>meta</li><li>name: keywords content: Java, Virtual Threads, Parallel Collectors, Project Loom, JDK21, Stream API, concurrency, performance</li></ul></li></ul><hr><h1 id="java虚拟线程和并行收集器的并行集合处理" tabindex="-1"><a class="header-anchor" href="#java虚拟线程和并行收集器的并行集合处理"><span>Java虚拟线程和并行收集器的并行集合处理</span></a></h1><h2 id="_1-引言" tabindex="-1"><a class="header-anchor" href="#_1-引言"><span>1. 引言</span></a></h2><p>在之前的文章中，我们介绍了并行收集器，这是一个小型的零依赖库，它使得自定义线程池中的Stream API能够进行并行处理。</p><p>Project Loom是引入轻量级虚拟线程（之前称为Fibers）到JVM的有组织努力的代号，最终在JDK21中完成。</p><p>让我们看看如何利用这个技术在并行收集器中。</p><h2 id="_2-maven依赖" tabindex="-1"><a class="header-anchor" href="#_2-maven依赖"><span>2. Maven依赖</span></a></h2><p>如果我们想开始使用这个库，我们需要在Maven的_pom.xml_文件中添加一个单一条目：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>\`&lt;dependency&gt;\`
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-结论" tabindex="-1"><a class="header-anchor" href="#_5-结论"><span>5. 结论</span></a></h2><p>在这篇文章中，我们有机会看到如何轻松地利用虚拟线程与并行收集器库，事实证明，它比传统的基于操作系统线程的解决方案更好地扩展。我们的测试机器在大约~16000个线程时达到了资源限制，而扩展到数百万虚拟线程却很容易。</p><p>如常，代码示例可以在GitHub上找到。</p><p>文章发布后30天内开放评论。对于超过此日期的任何问题，请使用网站上的联系表单。</p><p>OK</p>`,58),r=[n];function s(d,c){return l(),a("div",null,r)}const v=e(i,[["render",s],["__file","Parallel Collection Processing with Parallel Collectors and Virtual Threads.html.vue"]]),p=JSON.parse('{"path":"/posts/baeldung/Parallel%20Collection%20Processing%20with%20Parallel%20Collectors%20and%20Virtual%20Threads.html","title":"Java虚拟线程和并行收集器的并行集合处理","lang":"zh-CN","frontmatter":{"description":"很抱歉，由于网络问题，我无法访问并解析您提供的链接。请您检查链接是否有效，并确保网页可以正常访问。如果链接有效且可访问，您可以重新发送链接，我将尽力为您提供所需的翻译服务。--- date: 2024-06-19 category: Java Concurrency tag: Virtual Threads Parallel Collectors he...","head":[["meta",{"property":"og:url","content":"https://www.kahen.xyz/posts/baeldung/Parallel%20Collection%20Processing%20with%20Parallel%20Collectors%20and%20Virtual%20Threads.html"}],["meta",{"property":"og:site_name","content":"Baeldung 中文网"}],["meta",{"property":"og:title","content":"Java虚拟线程和并行收集器的并行集合处理"}],["meta",{"property":"og:description","content":"很抱歉，由于网络问题，我无法访问并解析您提供的链接。请您检查链接是否有效，并确保网页可以正常访问。如果链接有效且可访问，您可以重新发送链接，我将尽力为您提供所需的翻译服务。--- date: 2024-06-19 category: Java Concurrency tag: Virtual Threads Parallel Collectors he..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-06-18T22:11:04.000Z"}],["meta",{"property":"article:author","content":"Kahen"}],["meta",{"property":"article:modified_time","content":"2024-06-18T22:11:04.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Java虚拟线程和并行收集器的并行集合处理\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2024-06-18T22:11:04.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Kahen\\",\\"url\\":\\"https://www.kahen.xyz\\"}]}"]]},"headers":[{"level":2,"title":"1. 引言","slug":"_1-引言","link":"#_1-引言","children":[]},{"level":2,"title":"2. Maven依赖","slug":"_2-maven依赖","link":"#_2-maven依赖","children":[{"level":3,"title":"3.1. 操作系统线程并行性","slug":"_3-1-操作系统线程并行性","link":"#_3-1-操作系统线程并行性","children":[]},{"level":3,"title":"3.2. 虚拟线程并行性","slug":"_3-2-虚拟线程并行性","link":"#_3-2-虚拟线程并行性","children":[]},{"level":3,"title":"3.3. 虚拟线程和旧版本的并行收集器","slug":"_3-3-虚拟线程和旧版本的并行收集器","link":"#_3-3-虚拟线程和旧版本的并行收集器","children":[]}]},{"level":2,"title":"5. 结论","slug":"_5-结论","link":"#_5-结论","children":[]}],"git":{"createdTime":1718748664000,"updatedTime":1718748664000,"contributors":[{"name":"Kahen","email":"Kahen@users.noreply.github.com","commits":1}]},"readingTime":{"minutes":4.86,"words":1458},"filePathRelative":"posts/baeldung/Parallel Collection Processing with Parallel Collectors and Virtual Threads.md","localizedDate":"2024年6月18日","excerpt":"<p>很抱歉，由于网络问题，我无法访问并解析您提供的链接。请您检查链接是否有效，并确保网页可以正常访问。如果链接有效且可访问，您可以重新发送链接，我将尽力为您提供所需的翻译服务。---\\ndate: 2024-06-19\\ncategory:</p>\\n<ul>\\n<li>Java</li>\\n<li>Concurrency\\ntag:</li>\\n<li>Virtual Threads</li>\\n<li>Parallel Collectors\\nhead:</li>\\n<li>\\n<ul>\\n<li>meta</li>\\n<li>name: keywords\\ncontent: Java, Virtual Threads, Parallel Collectors, Project Loom, JDK21, Stream API, concurrency, performance</li>\\n</ul>\\n</li>\\n</ul>","autoDesc":true}');export{v as comp,p as data};
