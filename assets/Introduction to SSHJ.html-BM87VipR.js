import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,o as i,a as t}from"./app-CjdBCliS.js";const s={},a=t(`<h1 id="sshj简介-baeldung" tabindex="-1"><a class="header-anchor" href="#sshj简介-baeldung"><span>SSHJ简介 | Baeldung</span></a></h1><h2 id="_1-概览" tabindex="-1"><a class="header-anchor" href="#_1-概览"><span>1. 概览</span></a></h2><p><strong>SSHJ是一个使用SSH协议与远程服务器安全通信的开源Java库。</strong></p><p>在本文中，我们将介绍SSHJ库的基本功能。</p><h2 id="_2-依赖项" tabindex="-1"><a class="header-anchor" href="#_2-依赖项"><span>2. 依赖项</span></a></h2><p>要使用SSHJ库，我们需要向项目中添加以下依赖项：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>\`&lt;dependency&gt;\`
