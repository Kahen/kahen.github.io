...
head:
  - - meta
    - name: keywords
      content: Kafka, Streaming, Message Delivery, Semantics
---
# 流媒体平台中消息传递语义
...
![img](https://www.baeldung.com/wp-content/uploads/2022/10/event-flow-overview-1024x594.png)
...
**为了在Kafka中启用至多一次语义，我们需要在消费者端设置“_enable.auto.commit_”为“_true_”。**

如果发生故障并且消费者重启，它将查看最后持久化的偏移量。由于偏移量在实际事件处理之前就已经持久化了，我们无法确定消费者接收到的每个事件是否都已成功处理。在这种情况下，消费者可能会错过一些事件。

让我们可视化这种语义：
![img](https://www.baeldung.com/wp-content/uploads/2022/10/at-most-once-flow.png)
...
![img](https://www.baeldung.com/wp-content/uploads/2022/10/at-least-once-flow.png)
...
- **在生产者端设置属性“_ack_”的值为“_1_”**
- **在消费者端设置“_enable.auto.commit_”属性的值为“_false_”。**
- **设置“_enable.idempotence_”属性的值为“_true_”**
...
![img](https://www.baeldung.com/wp-content/uploads/2022/10/exactly-once-flow.png)
...
- **通过为每个生产者设置唯一的“_transaction.id_”值来启用幂等生产者和事务功能**
- **通过将属性“_isolation.level_”设置为“_read_committed_”来启用消费者的事务功能**
...
![img](https://www.baeldung.com/wp-content/themes/baeldung/icon/logo.svg)![img](https://secure.gravatar.com/avatar/ba372319eaeba50279f8ab63c58e438d?s=50&r=g)
